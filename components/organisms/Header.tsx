...
const MapSearchBarIfNeeded = ({ show = false }) =>
  !show ? null : (
    <div className="px-4">
      <div className="py-2 relative mx-auto text-gray-600">
        <input
          className="border border-gray-3 bg-white h-10 px-5 pr-10 rounded-lg text-sm focus:outline-none"
          type="search"
          name="search"
          placeholder="Buscar"
        />
        <a href="/map/mapPage" className="absolute right-0 top-0 mt-5 mr-4">
          <svg
